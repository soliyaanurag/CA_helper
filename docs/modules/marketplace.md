...
- Frontend (`frontend/src/features/marketplace/`): one placeholder page, "Find a CA" at `/business/marketplace` (business nav), built from `ModulePlaceholder`; `api.ts` is empty.
