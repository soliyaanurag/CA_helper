...
- Frontend (`frontend/src/features/documents/`): one placeholder page, "Document vault" at `/business/documents` (business nav), built from `ModulePlaceholder`; `api.ts` is empty.
